...
export default {
    ...
    components: {ButtonUi},
    layout: Layout,
    props: ['request', 'stores', 'statuses', 'shipments', 'trackingType', 'trackingNumber', 'errors'],
    data() {
        return {
            form: {
    ...
    methods: {
        submit() {
            router.put(this.route('requests.update', this.request.id), this.form);
        }
    }
}
</script>
...
<template>
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 class="text-title-md2 font-bold text-black">Редктирование заявки</h2>
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default py-4 px-6.5">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="inputComment" rows="4"
                                  class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" v-model="form.comment"></textarea>
                    ...
                    <div class="mb-5">
                        ...
                        <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            ...
                            <option v-for="status in statuses"
                                :selected="status.external_id === request.status"
                            ...
                            <div class="flex-none">
                                ...
                                <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    ...
                                    <option v-for="shipment in shipments"
                                            :selected="shipment === trackingType"
